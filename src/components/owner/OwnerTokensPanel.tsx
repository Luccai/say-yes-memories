...
export function OwnerTokensPanel() {
  ...
  return (
    <div>
      ...
      {revealed ? (
        <section ref={revealedDialogRef} role="dialog" aria-modal="true" aria-labelledby="revealed-token-title" tabIndex={-1} data-scroll-lock-allow="true" className="fixed inset-0 z-50 grid place-items-end overflow-y-auto bg-black/35 p-3 backdrop-blur-sm sm:place-items-center sm:p-6">
