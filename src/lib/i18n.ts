...
export const copy = {
  en: {
    ...
    admin: {
      ...
      identityTitle: "The page guests open from your QR or shared link.",
      ...
      qrTitle: "Share it with guests or print it on your table cards.",
      ...
      uploads: "Photos, videos, voice notes, and little messages",
      refresh: "Check again",
      all: "Everything",
      photos: "Photos",
      videos: "Videos",
